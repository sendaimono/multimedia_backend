"""Add users, rooms and messages table

Revision ID: a637c9029fb2
Revises: 
Create Date: 2019-01-08 17:09:09.207851
...
def upgrade():
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('room_gid', sa.String(), nullable=False),
